        ...
        <header>
          ...
          <div class="header-main">
            <div class="container">
              ...
              <div class="header-logo"><a href="home-shop.html" class="logo"><img src="assets/images/NewLogo.png" alt="fooday" class="logo-img mu-w-140"></a></div>
              <nav id="main-nav-offcanvas" class="main-nav-wrapper">
                <div class="close-offcanvas-wrapper"><span class="close-offcanvas">x</span></div>
                <div class="main-nav">
                  <ul id="main-nav" class="nav nav-pills">
                    <li class="dropdown current-menu-item"><a href="home-shop.html" class="dropdown-toggle">Home</a><i class="fa fa-angle-down btn-open-dropdown"></i>
                    ...
                    <li class="dropdown"><a href="menu-grid-2.html" class="dropdown-toggle">
                  ...
                  <div class="ft-widget-area">
                    <div class="ft-area1">
                      <div class="swin-wget swin-wget-about">
                        <div class="clearfix"><a class="wget-logo"><img src="assets/images/NewLogo-2.png" alt="" class="img img-responsive mu-w-140"></a>
                        ...
                        <div class="about-contact-info clearfix">
                          <div class="address-info">
                            ...
                            <div class="info-content">
                              <p>Chick Chicken, 5a Central Avenue, Welling, Kent, DA16 3AX.</p>
